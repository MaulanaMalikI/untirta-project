...
<html lang="id">
  <head>
    ...
    shrink-to-fit=no">
    <title>SMI Inventory</title>
    <link rel="icon" href="img/SMI.png" type="image/png">
  ...
  <nav id="main-navbar" class="navbar navbar-expand-md navbar-dark bg-dark py-0">
    ...
    <a class="navbar-brand" href="#">
      <img src="img/Logo SMI Untirta.png" alt="Logo" width="100" height="35" class="d-inline-block align-text-top">
    </a>
